...
export const LADDER_EXERCISES: LadderExercise[] = [
  ...
  { id: 'triceps-extension', name: 'Triceps Extension', aliases: ['Tricep Extension'], difficulty: 175 },
  { id: 'dips', name: 'Dips', aliases: [], difficulty: 200 },
  { id: 'archer-push-up', name: 'Archer Push-up', aliases: [], difficulty: 230 },
  { id: 'clap-push-up', name: 'Clap Push-up', aliases: [], difficulty: 260 },
  ...
  { id: 'handstand-push-up', name: 'Handstand Push-up', aliases: ['HSPU'], difficulty: 620 },
  { id: 'straddle-back-lever', name: 'Straddle Back Lever', aliases: [], difficulty: 660 },
  ...
  { id: 'front-lever-pull-up', name: 'Front Lever Pull-up', aliases: ['FL Pull-up'], difficulty: 920 },
  ...
  { id: 'manna', name: 'Manna', aliases: [], difficulty: 1100 },
  ...
  { id: 'one-arm-planche', name: 'One Arm Planche', aliases: ['OAP'], difficulty: 1620 },
