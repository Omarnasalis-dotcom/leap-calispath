...
// Single source of truth for WorldSelectorGrid
...
export const ONEMM_MOVEMENTS: OneMMMovement[] = [
  // ENTRY (Tiers 0-4)
  { id: 'knee_push_ups', name: 'Knee Push-ups', categoryId: 'entry', patternId: 'push', minTier: 0 },
  { id: 'inverted_row', name: 'Inverted Row', categoryId: 'entry', patternId: 'pull', minTier: 0 },
  { id: 'bench_dips', name: 'Bench Dips', categoryId: 'entry', patternId: 'dip', minTier: 0 },
  { id: 'air_squats', name: 'Air Squats', categoryId: 'entry', patternId: 'squat', minTier: 0 },
  ...
  { id: 'hspu', name: 'Handstand Push-ups', categoryId: 'advanced', patternId: 'hspu', minTier: 5 },
  { id: 'fl_press', name: 'Front Lever Press', categoryId: 'advanced', patternId: 'fl_press', minTier: 5 },
  { id: 'fl_pull_ups', name: 'Front Lever Pull-ups', categoryId: 'advanced', patternId: 'fl_pull', minTier: 5 },
  { id: 'planche_push_ups', name: 'Planche Push-ups', categoryId: 'advanced', patternId: 'planche', minTier: 5 },
];
