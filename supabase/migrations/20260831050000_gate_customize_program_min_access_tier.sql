-- Gate 2 continued: create_custom_program_from_workouts is the Pro/Max-only
-- creator (caller_is_pro_or_max()), so programs it builds are tagged
-- min_access_tier='pro' — stricter than the 'first' tag the two AI Coach
-- creators use (previous migration), matching their differing creation-time
-- requirements. Body otherwise unchanged from 20260829020000.
